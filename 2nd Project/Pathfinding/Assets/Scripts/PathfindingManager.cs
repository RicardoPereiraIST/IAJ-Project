...
public class PathfindingManager : MonoBehaviour {
	...
	void Update () 
	{
		...
		if (this.AStarPathFinding.InProgress)
		{
			...
			pathPositions = PathSmoothing.Instance.SmoothPath(this.currentSolution.PathPositions, navMesh, mode);
		}
	}
	...
	public void OnGUI()
	{
		if (this.currentSolution != null)
		{
			...
			var text = "Nodes Visited: " + this.AStarPathFinding.TotalExploredNodes
					   ...
					   + "\nTotal Edges:" + this.AStarPathFinding.TotalEdges
					   +"\nDiscarded edges:" + this.AStarPathFinding.DiscardedEdges;
