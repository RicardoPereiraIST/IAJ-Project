...
namespace Assets.Scripts.IAJ.Unity.Pathfinding
{
    public class NodeArrayAStarPathFinding : AStarPathfinding
    {
        ...
        protected override void ProcessChildNode(NodeRecord bestNode, NavigationGraphEdge connectionEdge, int connectionIndex)
        {
            ...
            {
                ChangeNodeValues(childNodeRecord, h, g, f, bestNode);
        ...
        private void ChangeNodeValues(NodeRecord node, float h, float g, float f, NodeRecord parent)
        {
            node.gValue = g;
            node.hValue = h;
            node.fValue = f;
